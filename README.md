...
When Crypti launches a new Dapp, it launches a NodeJS sandboxed process which communicates with Crypti via a [Named Pipe](https://en.wikipedia.org/wiki/Named_pipe), providing a safe execution environment for dapps to operate within.
